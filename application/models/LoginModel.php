			...
			if($query->num_rows() > 0) {
				...
				if($result->nivel == "Inactivo") {
					...
					if(md5($contrasenia) == $result->contrasenia){
						...
						$obj['usuario']['link_dashboard'] = $result->link_dashboard;
						$obj['usuario']['link_usuarios'] = $result->link_usuarios;
						$obj['usuario']['link_proveedores'] = $result->link_proveedores;
						$obj['usuario']['link_configuracion'] = $result->link_configuracion;
