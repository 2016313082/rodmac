...
<html lang="en">
	...
	<body>
					...
					<div class="botones_crud mt-4">
						...
						<div class="row">
							<div class="col-sm-6 offset-sm-6 col-12 d-flex justify-content-center align-items-end">
								<button class="btn btn-success btn-block" type="button" data-toggle="modal" data-target="#agregar-proveedor">Agregar nuevo proveedor</button>
							</div>
						</div>
					</div>
					<div class="row mt-4">
						...
						<form method="post" id="formulario_agregar">
							<div class="form-row">
								<div class="col-12 form-group">
									<label for="empresa_nuevo">Nombre de la empresa</label>
									<input class="form-control" type="text" id="empresa_nuevo" name="empresa" required>
								</div>
							</div>
							<div class="form-row">
								<div class="col-6 form-group">
									<label for="ciudad_nuevo">Ciudad</label>
							...
							<div class="form-row">
								...
								<div class="col-4 form-group">
									<label for="contacto_nuevo">Responsable</label>
							...
							<div class="form-row">
								<div class="col-6 form-group">
									<label for="pagina_nuevo">Página web</label>
		...
		<script src="<?= base_url() ?>static/js/proveedores/proveedores.js"></script>
	</body>
</html>
