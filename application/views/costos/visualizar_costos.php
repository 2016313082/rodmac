...
<html lang="en">
	<head>
		...
		<script>var id_costo = "<?= $id_costo ?>"</script>
	</head>
	<body>
			...
			<div id="content" class="container-fluid">
				...
				<div class="pl-4 pr-4 pt-2 pd-2 mt-2">
					...
					<form method="post" id="formulario_articulo">
						<div class="row mt-2">
							<div class="col-sm-6">
								<label for="id_costo">Id del costo</label>
								<input class="form-control" type="text" id="id_costo" name="id_costo" readonly value="<?= $id_costo?>">
							</div>
							<div class="col-sm-6">
								<label for="nombre_articulo">Nombre del articulo</label>
								<input class="form-control" type="text" id="nombre_articulo" readonly name="nombre_articulo">
							</div>
						</div>
						<div class="row mt-2">
							<div class="col-sm-4">
								<label for="costo_MXN">Costo MXN</label>
								<input class="form-control" type="text" id="costo_MXN" name="costo_MXN" readonly>
							</div>
							<div class="col-sm-4">
								<label for="costo_USD">Costo USD</label>
								<input class="form-control" type="text" id="costo_USD" name="costo_USD" readonly>
							</div>
							<div class="col-sm-4">
								<label for="id_tipo_articulo">Tipo de articulo</label>
								<input class="form-control" type="text" id="nombre_tipo_articulo" name="nombre_tipo_articulo" readonly>
							</div>
						</div>
						<div class="row mt-4">
							<div class="col-4">
								<a class="btn btn-primary form-control" href="<?= base_url() ?>Costos/vista_editar/<?= $id_costo?>" type="submit">Editar</a>
							</div>
							<div class="col-4">
								<a class="btn btn-secondary form-control" href="">Imprimir/Descargar PDF</a>
							</div>
							<div class="col-4">
		...
		<script src="<?= base_url() ?>static/js/costos/visualizar_costos.js"></script>
	</body>
</html>