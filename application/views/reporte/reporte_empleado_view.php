...
<html>
	...
	<body>
		<div class="container pb-2">
			...
			<div class="pr-5 pl-5">
				...
				<div class="row text-center condiciones-pago mb-2">
					...
					<div class="col-3">
						<div class="input-group">
							<input type="number" class="form-control" id="anticipo" value="70" readonly>
				...
				<div class="row text-center condiciones-pago mb-2">
					...
					<div class="col-3">
						<div class="input-group">
							<input type="number" class="form-control" id="fin-instalacion" value="20" readonly>
							<div class="input-group-append">
								<span class="input-group-text">%</span>
							</div>
						</div>
				...
				<div class="row text-center condiciones-pago">
					...
					<div class="col-3">
						<div class="input-group">
							<input type="number" class="form-control" id="cambio-medidor" value="10" readonly>
							<div class="input-group-append">
								<span class="input-group-text">%</span>
							</div>
						</div>
		...
		<script src="<?= base_url() ?>static/js/reporte/reporte_empleado.js"></script>
	</body>
</html>