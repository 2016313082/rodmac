...
<html lang="en">
	<head>
		<title>Iniciar sesión | Rodmac</title>
		<meta charset="utf-8">
		...
		<div class="container h-100">
			<div class="row align-items-center h-100">
				<div id="login-box" class="col-sm-6 mx-auto d-flex align-items-center">
					<div>
						<img id="login-logo" src="<?= base_url() ?>img/logorodmactransparente.png">
						<form id="login-form" class="text-center" method="post" action="<?= base_url() ?>login/iniciar_sesion">
							<div class="form-group">
								<label for="usuario">Usuario</label>
								<input name="usuario" required class="form-control" type="text" id="usuario" value="<?php if($this->session->flashdata('nombre_usuario')) { echo $this->session->flashdata('nombre_usuario'); } ?>" autofocus>
							</div>
							<div class="form-group mb-4">
								<label for="contrasenia">Contraseña</label>
								<input name="contrasenia" required class="form-control" type="password" id="contrasenia">
							</div>
