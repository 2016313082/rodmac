...
<script src="<?= base_url() ?>static/js/inputmask.min.js"></script>
<script src="<?= base_url() ?>static/js/jquery.number.js"></script>
<script src="<?= base_url() ?>static/js/bootstrap-input-spinner.js"></script>
